...
async def get_all_convoations(skip: int = 0, limit: int = 10, convocation_service: ConvocationService = Depends(get_convocation_service)):
    """
    Retrieve a list of convocations.
    ...
    Returns:
        List[Convocation]: A list of convocation data.
    """
    return await convocation_service.get_all_convoations(skip, limit)
