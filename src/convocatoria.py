...
from ..dependencies import get_convocation_repo
from typing import List
...
def get_convocation_repo(db: AsyncSession = Depends(get_db)) -> ConvocationRepository:
    """
    ...
    """
    return ConvocationRepository(db)